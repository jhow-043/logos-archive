...
> MOC da disciplina Fundamentos de Química I — 1º Semestre. Cobre os conceitos fundamentais da ciência química: matéria, modelos atômicos, estequiometria e reações em solução.
...
| Unidade | Tema | Status |
| ------- | ---- | ------ |
| U1 | Conceitos fundamentais de química | ✅ |
| U2 | Átomos, íons e moléculas | 🔲 |
| U3 | Estequiometria — cálculos com fórmulas | 🔲 |
| U4 | Estequiometria e reações em solução | 🔲 |

---

## U1 — Conceitos Fundamentais

| # | Nota | Status |
|---|------|--------|
| 1 | [[O que é Química]] | ✅ |
| 2 | [[Estados da Matéria e Classificação]] | ✅ |
| 3 | [[Elementos, Compostos e Substâncias Puras]] | ✅ |
| 4 | [[Misturas Homogêneas, Heterogêneas e Coloides]] | ✅ |
| 5 | [[Grandezas Físicas e Sistema Internacional (SI)]] | ✅ |
| 6 | [[Algarismos Significativos]] | ✅ |
| 7 | [[Precisão × Exatidão e Tratamento de Erros]] | 🟡 |
...
- CHANG, R.; GOLDSBY, K. A. *Química*. 9ª ed. Rio de Janeiro: LTC, 2017.
- TOMA, H. E. *Estrutura atômica, ligações e estereoquímica*. São Paulo: Blucher, 2017.
- WELLER, M. T. et al. *Química Inorgânica*. 6ª ed. Porto Alegre: Bookman, 2017.
